...
## modify Holt, Gentry, and Nodaway counties
# county_subset %>%
  # mutate(case_avg_rate = ifelse(geoid == 29075 & 
  #                                (report_date == "2020-11-14" | report_date == "2020-11-15" |
  #                                   report_date == "2021-09-28"), 160, case_avg_rate)) %>%  # 165-190ish
  # mutate(case_avg_rate = ifelse(geoid == 29147 &  report_date == "2020-11-16", 160, case_avg_rate)) %>% # 165ish
  # mutate(case_avg_rate = ifelse(geoid == 29087 &
  #                                (report_date == "2020-11-22" | report_date == "2020-11-24"), 160, case_avg_rate)) %>% # 165-175ish
  # mutate(case_avg_rate = ifelse(geoid == 29087 &  report_date == "2020-11-23", NA, case_avg_rate)) -> county_subset # 175ish
