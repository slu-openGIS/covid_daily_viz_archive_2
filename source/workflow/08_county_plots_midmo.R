...
#                                  (report_date == "2020-10-02" | report_date == "2020-10-06"), 160, case_avg_rate), # 160-170
...
#                                  (report_date == "2020-10-19" | report_date == "2020-10-20"), 160, case_avg_rate) # 170
#  ) %>%
#  mutate(case_avg_rate = ifelse(geoid == 29135 & 
#                                  (report_date == "2020-11-14" | report_date == "2020-11-16"), 160, case_avg_rate), # 170-180
